...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/phase62logo.png" rel="icon">
        ...
        <ul class="nav-inner">
          ...
          <li class="drop-down"><a href="">Tugas</a>
            <ul>
              ...
              <li><a href="#team">Video</a></li>

              <li class="drop-down"><a href="#">Pekan ke-</a>
                <ul>
          ...
          <li class="nav-logo"><a href="index.html"><img src="assets/img/phase62logo.png" alt="" class="img-fluid" style="height: 70px;"></a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="content pt-4 pt-lg-0 pl-0 pl-lg-3 ">
              <h3>Lebih dekat dengan panitia Phase 62 2020</h3>
              <p class="font-italic">
